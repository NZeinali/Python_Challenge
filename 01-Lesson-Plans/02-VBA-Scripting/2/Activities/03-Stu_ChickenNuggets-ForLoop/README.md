...
Now it's your chance to see how quickly we can create data utilising the power of a computer and FOR loops!
...
* If you finish early, talk to your neighbour about why you may want to use a For loop in preference to the "range" function.
